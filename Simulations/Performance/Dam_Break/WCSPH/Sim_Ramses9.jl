...
# WCSPH parameters
cfl = 1.3
smoothing_length = 1.8 * fluid_particle_spacing
...
plot_name1 = file_name * "_" * method * "_" * string(resolution) * "_" * density_calculator_boundary * "_cfl" * cfl_string * "_sl" * sl_string
