...
saving_paper = SolutionSavingCallback(save_times=[0.0, 0.5, 1.5, 2.5, 5.0], output_directory="Output/Cylinder/IISPH/PressureMirroring",
                                      prefix="IISPH_PressureMirroring_Cylinder")
