...
saving_paper = SolutionSavingCallback(save_times=[0.0, 0.5, 1.5, 2.5, 5.0].*time_factor, output_directory="Output/PeriodicCylinder/IISPH/PressureBoundaries",
                                      prefix="IISPH_PressureBoundaries_PeriodicCylinder")
